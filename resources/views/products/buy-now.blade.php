                                    ...
                                    <div class="checkout-product-wrap checkout-product">
                                        <div class="product-info-wrap product-info">
                                            ...
                                            <span class="product-info-title"><span
                                                    class="product-info-text">{{ $product->name }}</span>
                                                <div class="product-info-category">
                                                    <span
                                                        class="product-info-category-wrap product-info-category-text">{{ $product->agency->name }}</span>
                                                </div>
                                            </span>
                                        </div>
                                        ...
                                        <div class="product-info-wrap">
                                            @if ($product->discounted_price)
                                                @php
                                                    $overallSubtotal += $product->discounted_price * $quantity;
                                                @endphp
                                            ...
                                            @else
                                                @php
                                                    $overallSubtotal += $product->price * $quantity;
                                                @endphp
                                        ...
                                        <div class="product-info-wrap product-info-total">
                                            @if ($product->discounted_price)
                                                <span class="product-info-text">
                                                    Rp.
                                                    {{ number_format($product->discounted_price * $quantity, 0, '.', '.') }}
                                                </span>
                                            @else
                                                <span class="product-info-text product-info-text-discounted">Rp.
                                                    {{ number_format($product->price * $quantity, 0, '.', '.') }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
